...
"[project]/src/hooks/useElectron.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useElectron() {
    _s();
    const [electronAPI, setElectronAPI] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useElectron.useEffect": ()=>{
            // Electron 환경 감지
            const checkElectron = "object" !== 'undefined' && window && window.process && window.process.versions && Boolean(window.process.versions.electron);
...
_s(useElectron, "Glq4BGbZ2CvCsTeW6J8loyB3XP4=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/types/settings.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useElectron$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useElectron.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/settings.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
;
// 기본 설정 값 - 공통 타입에서 가져옴
const defaultSettings = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_SETTINGS"];
function useSettings() {
    _s();
    const { isElectron, electronAPI } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useElectron$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useElectron"])();
                ...
                if (isElectron && electronAPI && electronAPI.settings) {
                    ...
                    try {
                        ...
                        if (loadedSettings && typeof loadedSettings === 'object') {
                            ...
                            const mergedSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeSettings"])(defaultSettings, loadedSettings);
                            const isValid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateSettings"])(mergedSettings);
                            console.debug('[설정 검증] 병합된 설정:', {
                                isValid: isValid,
                                settingCount: Object.keys(mergedSettings).length
                            });
                            if (isValid) {
                            ...
                            // 기본값을 백엔드에 저장
                            try {
                                const saveResult = await electronAPI.settings.updateMultiple({
                                    ...defaultSettings
                                });
    ...
    const loadFromLocalStorage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSettings.useCallback[loadFromLocalStorage]": async ()=>{
            try {
    ...
    }["useSettings.useCallback[loadFromLocalStorage]"], []);
    ...
    const saveSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSettings.useCallback[saveSettings]": async (newSettings)=>{
    ...
    }["useSettings.useCallback[saveSettings]"], [
        settings,
        isElectron,
        electronAPI
    ]);
    ...
    const updateSetting = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSettings.useCallback[updateSetting]": (key, value)=>{
    ...
    const toggleTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSettings.useCallback[toggleTheme]": ()=>{
            ...
            if (newTheme === 'system') {
                // 시스템 다크모드 감지
                const systemDarkMode = "object" !== 'undefined' && window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches;
    ...
    const toggleDarkMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSettings.useCallback[toggleDarkMode]": ()=>{
    ...
    // GPU 가속 토글
    const toggleGPUAcceleration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSettings.useCallback[toggleGPUAcceleration]": ()=>{
...
_s(useSettings, "P6NvA4sP344dRLZqruMqW2j5ZeQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useElectron$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useElectron"]
    ];
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
"[project]/src/app/components/ui/ThemeProvider.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_s1(ThemeProvider, "1F4rbBg/vBfmJJZxL4QzWDKDPKk=", false, function() {
    return [
...
"[project]/src/app/components/ui/HydrationFix.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function HydrationFix() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HydrationFix.useEffect": ()=>{
                ...
                "HydrationFix.useEffect.performCleanup": ()=>{
                    ...
                    try {
                        ...
                        if (svgElements.length > 0) {
                            ...
                            svgElements.forEach({
                                "HydrationFix.useEffect.performCleanup": (svg)=>{
            ...
            if (document.readyState !== 'complete') {
                const handleLoad = {
                    "HydrationFix.useEffect.handleLoad": ()=>{
    ...
    }["HydrationFix.useEffect"], []); // 빈 배열로 한 번만 실행
    return null;
}
...
const ToastProvider = ({ children })=>{
    ...
    const addToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ToastProvider.useCallback[addToast]": (toast)=>{
            ...
            }["ToastProvider.useCallback[addToast]"], toast.duration || 5000);
        }
    }["ToastProvider.useCallback[addToast]"], []);
...
const ToastItem = ({ toast, removeToast })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `${bgColor} ${textColor} border rounded-lg shadow-lg p-4 min-w-[300px] max-w-[500px]`,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ui$2f$HydrationFix$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/ui/HydrationFix.tsx [app-client] (ecmascript)");
...
function Providers({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        client: queryClient,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ui$2f$ThemeProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ui$2f$HydrationFix$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToastProvider"], {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$notifications$2f$NotificationProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationProvider"], {
                        children: children
                    }, void 0, false, {
                        fileName: "[project]/src/app/providers.tsx",
                        lineNumber: 25,
...
_s(Providers, "fBQUdypDkp8gl+m1629PxU+ybhM=");
_c = Providers;
var _c;
...
//# sourceMappingURL=_9c7c5187._.js.map